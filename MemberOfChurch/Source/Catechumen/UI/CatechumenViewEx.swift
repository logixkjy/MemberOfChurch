...
extension CatechumenView {
    internal struct CatechumenSectionView: View {
        let members: Array<CatechumenEntity>?
        ...
        var filteredMembers: [CatechumenEntity] {
        ...
        func groupMembersByInitial(_ list: [CatechumenEntity]) -> [String: [CatechumenEntity]] {

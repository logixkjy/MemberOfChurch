...
struct CatechumenView: View {
    ...
    let catechumenStore: StoreOf<CatechumenCore>
    
    init(catechumenStore: StoreOf<CatechumenCore>) {
        self.catechumenStore = catechumenStore
    }
    
    var body: some View {
        WithViewStore(self.catechumenStore, observe: { $0 }) { viewStore in
            ZStack {
                GeometryReader { geo in
                    VStack {
                        ...
                        CatechumenSectionView(
                            members: viewStore.catechumenLists ?? [],
                    ...
                    .background(.green04)
                    .task {
                        viewStore.send(.getCatechumenLists)
                    }
                }

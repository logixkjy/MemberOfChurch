...
extension WrkOrgView {
    internal struct WrkOrgListSectionView: View {
        let members: Array<WrkOrgEntity>?
        ...
        var filteredMembers: [WrkOrgEntity] {
        ...
        func groupMembersByInitial(_ list: [WrkOrgEntity]) -> [String: [WrkOrgEntity]] {
